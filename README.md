# CasualtiesUnknownTeleport

一个模组，基于 BepInEx来使用，可以更好地传送
这个模组需要多人联机模组主机是单端配置，也就是说只需要服务端使用，客户端不需要安装。内置tp指令，需要靠多人联机模组的聊天功能来实现指令功能
...
`\tp list` - list the anchor points players can teleport to
